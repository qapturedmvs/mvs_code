							...
							<ul>
								<?php 
									...
									foreach($casts as $cast): 
										if($i < 3):
								?>
								<li class="topBilled"><a href="#<?php echo $cast->str_slug; ?>"><img src="<?php if($cast->str_photo != '') echo $cast->str_photo; else echo $site_url."images/actor.jpg"; ?>" alt="<?php echo $cast->str_name; ?>" title="<?php echo $cast->str_name; ?>" /></a></li>
								<?php else:?>
								<li><span class="actor"><a href="#<?php echo $cast->str_slug; ?>"><?php echo $cast->str_name; ?></a></span><span class="character"><?php echo $cast->char_name; ?></span></li>
								<?php endif; ?>
								<?php 
									$i++;
									endforeach; 
