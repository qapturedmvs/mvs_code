<section class="ReviewListHolder wallHolder" ng-controller="userWall" infinite-scroll="reddit.nextPage()" infinite-scroll-disabled="reddit.busy" infinite-scroll-distance="0">
              ...
              <div class="contentRight">
                ...
                <div class="repHolder" ng-if="item.feed_ref_count != null">
                      ...
                      <div class="contentRight">
                        ...
                        <div class="text" ng-if="rep.text_char <= 500">{{rep.feed_text}}</div>
												<div class="text" ng-if="rep.text_char > 500">{{rep.text_start}}
                          <span class="dots">... </span>
                          <button class="readMore" onclick="readMore(this);">see more</button>
                        </div>
                        <?php if($logged_in): ?>
