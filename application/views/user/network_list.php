...
<div rel="<?php echo $controls['page']; ?>" class="pageDefault pageNetwork page-<?php echo $controls['page']; ?>">
	...
	<div class="listHolder" ng-controller='userNetwork'>
		<ul>
			<li class="listItem userItem" ng-repeat='item in items'  usr-id="{{item.usr_id}}">
				...
				<div class="followHolder">
					<a ng-if="item.flw_id==0" rel="follow" onclick="follow_unfollow(this)" href="javascript:void(0);"><span class="flw">Follow</span><span class="uflw">Unfollow</span></a>
					<a ng-if="item.flw_id!=0" flw-id="{{item.flw_id}}" rel="unfollow" onclick="follow_unfollow(this)" href="javascript:void(0);"><span class="flw">Follow</span><span class="uflw">Unfollow</span></a>
				</div>
				<?php endif; ?>
			</li>
		</ul>
