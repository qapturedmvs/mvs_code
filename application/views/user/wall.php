          ...
          <div ng-switch="item.type">
            <div ng-switch-when='0'>
              ...
              <div act-id="{{item.feed_id}}" class="feedHolder rv2" ng-if="item.feed_type == 'rv' && item.act_type_id == 2">
                ...
                <div class="refHolder" ng-if="item.feed_ref_count != null"> <a class="btnShowReplies" href="javascript:void(0);" ng-if="item.feed_ref_count > 2">{{item.feed_ref_count - 2}} more reviews</a>
                  <div class="refs">
            ...
            <div id="year{{item.result}}" ng-switch-when='3'><a href="javascript:void(0);">{{item.result}}</a></b></div>
          </div>
        </li>
      </ul>
