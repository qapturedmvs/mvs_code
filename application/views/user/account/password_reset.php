...
<?php if($pwr_result !== 'success'): ?>
	...
	<?php echo form_open($current_url.'?act='.$act, array('class' => 'form-password-reset', 'role' => 'form')); ?>
		...
		<input name="pwr_password" id="pwr_password" type="password" class="form-control" placeholder="Password" required>
		<input name="repassword" id="repassword" type="password" class="form-control" placeholder="Re-enter Password" required>
