<script type="text/javascript">
	var list_id = <?php echo $the_user['view_user']->list_id; ?>;
</script>
<div class="pageDefault pageCustomListDetail">
	...
	<div class="titleDefault titleCustomList">
		<h4 class="normal-mode"><?php echo $the_user['view_user']->list_title; ?></h4>
		<input type="text" class="listTitle edit-mode" value="<?php echo $the_user['view_user']->list_title; ?>" />
	</div>
